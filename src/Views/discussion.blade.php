	        ...
	        <div class="col-md-12">
	                	...
	                	@foreach($posts as $post)
	                		<li data-id="{{ $post->id }}">
		                		<span class="chatter_posts">
		                			@if(!Sentinel::guest() && (Sentinel::getUser()->id == $post->user->id))
				...
				@else
					...
					<div id="login_or_register">
						<p>Please <a href="#" class="logInNow">login</a> or <a href="#" class="signUpNow">register</a> to leave a response.</p>
					</div>
...
@include('includes.modals._login_register')
...
@include('includes.modals._login_register_scripts')
@stop